...
unsigned char incrementar_anterior = 0;
unsigned char tecla_incrementar (void)
{
...
unsigned char tecla_incrementar_subida (void)
{
    if (!incrementar_anterior && PORTCbits.RC5)
    {
        incrementar_anterior = PORTCbits.RC5;
        return (1);
    }
    else
    {
...
unsigned char decrementar_anterior = 0;
unsigned char tecla_decrementar (void)
{
...
unsigned char tecla_decrementar_subida (void)
{
    if (!decrementar_anterior && PORTCbits.RC4)
    {
        decrementar_anterior = PORTCbits.RC4;
        return (1);
    }
    else
    {
